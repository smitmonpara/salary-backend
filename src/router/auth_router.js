...
const { sendEmailOtp, register, login, resetPassword, verifyResetPasswordOtp, createNewPassword, profile, socialLogin, updateProfile, logout, changePassword, feedback } = require("../controller/auth_controller");
