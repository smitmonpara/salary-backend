...
const { createCategory, getAllCategories, getCategory, deleteCategory, updateCategory, getAllUserCategories } = require("../controller/category_controller");
...
router.get("/user", verifyUser([USER_ROLE.USER]), getAllUserCategories);
